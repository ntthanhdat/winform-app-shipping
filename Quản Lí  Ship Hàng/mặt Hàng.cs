...
namespace Quản_Lí__Ship_Hàng
{
    public partial class Fmathang : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                DataTable dt = new DataTable();
                dt = da.xuly("select * from mathang where tenhang = '" + textBox2.Text + "'");
                if (dt.Rows.Count > 0)
                {
                    MessageBox.Show("Mat Hang da co");
                }
                else
                {
                    //try
                   // {
                        MH.InsertMh(this.textBox1.Text, this.textBox2.Text, this.textBox3.Text, this.textBox4.Text,this.textBox5.Text);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MH.UpdateMh(this.textBox1.Text, this.textBox2.Text, this.textBox3.Text, this.textBox4.Text,this.textBox5.Text, this.textBox1.Text);
