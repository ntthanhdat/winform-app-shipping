...
namespace Quản_Lí__Ship_Hàng
{
    public partial class Ftaikhoan : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    try
                    {
                        tk.InsertTK(this.textBox1.Text, this.textBox2.Text, comboBox1.SelectedValue.ToString());
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                tk.UpdateTK(this.textBox1.Text, this.textBox2.Text, comboBox1.SelectedValue.ToString());
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            this.textBox1.Text = dataGridView1.Rows[i].Cells[1].Value.ToString();
            this.textBox2.Text = dataGridView1.Rows[i].Cells[2].Value.ToString();
        }
